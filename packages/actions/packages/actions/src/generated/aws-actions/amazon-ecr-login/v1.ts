...
export interface AwsActionsAmazonEcrLoginV1Props extends Omit<
...
export class AwsActionsAmazonEcrLoginV1 extends BaseAction<AwsActionsAmazonEcrLoginV1Outputs> {
