...
export interface AwsActionsConfigureAwsCredentialsV3Props extends Omit<
...
export class AwsActionsConfigureAwsCredentialsV3 extends BaseAction<AwsActionsConfigureAwsCredentialsV3Outputs> {
