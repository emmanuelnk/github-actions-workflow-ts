...
export type AwsActionsConfigureAwsCredentialsV4Outputs =
  | 'aws-account-id'
  | 'aws-access-key-id'
...
export interface AwsActionsConfigureAwsCredentialsV4Props extends Omit<
...
export class AwsActionsConfigureAwsCredentialsV4 extends BaseAction<AwsActionsConfigureAwsCredentialsV4Outputs> {
