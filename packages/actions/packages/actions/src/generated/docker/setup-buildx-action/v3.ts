...
export interface DockerSetupBuildxActionV3Props extends Omit<
...
export class DockerSetupBuildxActionV3 extends BaseAction<DockerSetupBuildxActionV3Outputs> {
