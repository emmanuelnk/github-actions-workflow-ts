...
export interface PeaceirisActionsGhPagesV3Props extends Omit<
...
export class PeaceirisActionsGhPagesV3 extends BaseAction<PeaceirisActionsGhPagesV3Outputs> {
