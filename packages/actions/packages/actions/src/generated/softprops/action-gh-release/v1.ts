...
export type SoftpropsActionGhReleaseV1Outputs =
  | 'url'
  | 'id'
  | 'upload_url'
  | 'assets'

export interface SoftpropsActionGhReleaseV1Props extends Omit<
...
export class SoftpropsActionGhReleaseV1 extends BaseAction<SoftpropsActionGhReleaseV1Outputs> {
