 ...
 */
export const ActionsCheckoutV3SourceVersion = 'v3.6.0'

export interface ActionsCheckoutV3Inputs {
...
export type ActionsCheckoutV3Outputs = never

export interface ActionsCheckoutV3Props {
   ...
   * - Default: 'actions/checkout@v3' (uses latest v3.x.x)
   * - Pinned: 'actions/checkout@v3.6.0' (types generated from this version)
...
export class ActionsCheckoutV3 extends BaseAction<
  'actions/checkout@v3',
  ActionsCheckoutV3Outputs
> {
  static readonly sourceVersion = 'v3.6.0'
  static readonly defaultUses = 'actions/checkout@v3'
