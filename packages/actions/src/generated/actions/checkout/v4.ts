 ...
 */
export const ActionsCheckoutV4SourceVersion = 'v4.3.1'
...
export type ActionsCheckoutV4Outputs = 'ref' | 'commit'

export interface ActionsCheckoutV4Props {
   ...
   * - Default: 'actions/checkout@v4' (uses latest v4.x.x)
   * - Pinned: 'actions/checkout@v4.3.1' (types generated from this version)
...
export class ActionsCheckoutV4 extends BaseAction<
  'actions/checkout@v4',
  ActionsCheckoutV4Outputs
> {
  static readonly sourceVersion = 'v4.3.1'
  static readonly defaultUses = 'actions/checkout@v4'

  constructor(props: ActionsCheckoutV4Props = {}) {
    ...
    super(
      {
        ...
        ...(env !== undefined && { env }),
        ...rest,
      } as GeneratedWorkflowTypes.Step & { uses: 'actions/checkout@v4' },
      outputNames,
      'v4.3.1',
      'actions/checkout@v4',
    )
