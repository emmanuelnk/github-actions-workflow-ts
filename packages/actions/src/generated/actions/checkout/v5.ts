 ...
 */
export const ActionsCheckoutV5SourceVersion = 'v5.0.1'
...
export type ActionsCheckoutV5Outputs = 'ref' | 'commit'

export interface ActionsCheckoutV5Props {
   ...
   * - Default: 'actions/checkout@v5' (uses latest v5.x.x)
   * - Pinned: 'actions/checkout@v5.0.1' (types generated from this version)
   * - Custom: Any valid ref (commit SHA, branch, tag, or fork)
   */
  uses?:
    | 'actions/checkout@v5'
    | 'actions/checkout@v5.0.1'
    | (`actions/checkout@${string}` & {})
...
export class ActionsCheckoutV5 extends BaseAction<
  'actions/checkout@v5',
  ActionsCheckoutV5Outputs
> {
  static readonly sourceVersion = 'v5.0.1'
  static readonly defaultUses = 'actions/checkout@v5'

  constructor(props: ActionsCheckoutV5Props = {}) {
    ...
    super(
      {
        ...
        ...(env !== undefined && { env }),
        ...rest,
      } as GeneratedWorkflowTypes.Step & { uses: 'actions/checkout@v5' },
      outputNames,
      'v5.0.1',
      'actions/checkout@v5',
    )
