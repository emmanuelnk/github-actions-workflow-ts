 ...
 */
export const ActionsCheckoutV6SourceVersion = 'v6.0.1'
...
export interface ActionsCheckoutV6Props {
   ...
   * - Default: 'actions/checkout@v6' (uses latest v6.x.x)
   * - Pinned: 'actions/checkout@v6.0.1' (types generated from this version)
...
> {
  static readonly sourceVersion = 'v6.0.1'
  static readonly defaultUses = 'actions/checkout@v6'
