 ...
 */
export const ActionsUploadArtifactV4SourceVersion = 'v4.6.2'
...
export interface ActionsUploadArtifactV4Props {
   ...
   * - Default: 'actions/upload-artifact@v4' (uses latest v4.x.x)
   * - Pinned: 'actions/upload-artifact@v4.6.2' (types generated from this version)
...
> {
  static readonly sourceVersion = 'v4.6.2'
  static readonly defaultUses = 'actions/upload-artifact@v4'
