 ...
 */
export const PeaceirisActionsGhPagesV4SourceVersion = 'v4.0.0'
...
export interface PeaceirisActionsGhPagesV4Props {
   ...
   * - Default: 'peaceiris/actions-gh-pages@v4' (uses latest v4.x.x)
   * - Pinned: 'peaceiris/actions-gh-pages@v4.0.0' (types generated from this version)
...
> {
  static readonly sourceVersion = 'v4.0.0'
  static readonly defaultUses = 'peaceiris/actions-gh-pages@v4'
